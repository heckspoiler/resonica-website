 ...
 * Inline arrow glyph (↗).
 *
 * Sized in `em` and filled with `currentColor` by default, so when it is
 * placed inside a link it automatically matches the size and colour of the
 * text next to it – including hover states. Override via props if needed.
 */
